 ...
 * @version 0.1
 */
public class RotatingLabel extends Label {
  private Timer timer;
...
/**
   ...
   * @param y DOCUMENT ME!
   */
  public RotatingLabel( PApplet p, String text, float x, float y ) {
    super( p, text, x, y );
...
/**
   ...
   * @param y DOCUMENT ME!
   */
  public RotatingLabel( PApplet p, String text, Font font, float x, float y ) {
...
/**
   ...
   */
  public RotatingLabel( PApplet p, String text, Font font, float x, float y, float width,
                        float height ) {
